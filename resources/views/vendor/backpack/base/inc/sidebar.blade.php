    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="header">AGE BUILD</li>
                <li>
                    <a href="{{ url(config('backpack.base.route_prefix', 'admin').'/faction') }}">
                        <i class="fa fa-font-awesome"></i> <span>Factions</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url(config('backpack.base.route_prefix', 'admin').'/army') }}">
                        <i class="fa fa-font-awesome"></i> <span>Armies</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url(config('backpack.base.route_prefix', 'admin').'/warscroll') }}">
                        <i class="fa fa-font-awesome"></i> <span>Warscrolls</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url(config('backpack.base.route_prefix', 'admin').'/battlefield-role') }}">
                        <i class="fa fa-font-awesome"></i> <span>Battlefield Roles</span>
                    </a>
                </li>
